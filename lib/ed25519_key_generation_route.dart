...
class Ed25519KeyGenerationRoute extends StatefulWidget {
  const Ed25519KeyGenerationRoute({Key? key}) : super(key: key);

  final String title = 'ED25519 Schlüsselerzeugung';

  @override
  _MyFormPageState createState() => _MyFormPageState();
}

class _MyFormPageState extends State<Ed25519KeyGenerationRoute> {
  @override
  void initState() {
    super.initState();
                    ...
                    Expanded(
                      child: ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          final privateKeyBase64 = base64Encoding(signingKey.toUint8List());
                          final publicKeyBase64 = base64Encoding(verifyKey.toUint8List());
